...
export async function listPaykuSubscriptions(req: Request, res: Response): Promise<void> {
  try {
...
export async function getPaykuSubscriptionStatus(req: Request, res: Response): Promise<void> {
  try {
    await verifyFirebaseToken(req.headers.authorization);
  } catch {
    res.status(401).json({ error: 'Unauthenticated' });
...
export async function listPaykuClients(req: Request, res: Response): Promise<void> {
  try {
    await verifyFirebaseToken(req.headers.authorization);
  } catch {
    res.status(401).json({ error: 'Unauthenticated' });
...
export async function getPaykuClient(req: Request, res: Response): Promise<void> {
  try {
    await verifyFirebaseToken(req.headers.authorization);
  } catch {
    res.status(401).json({ error: 'Unauthenticated' });
...
export async function createPaykuClientFn(req: Request, res: Response): Promise<void> {
  try {
    await verifyFirebaseToken(req.headers.authorization);
  } catch {
    res.status(401).json({ error: 'Unauthenticated' });
...
export async function updatePaykuClient(req: Request, res: Response): Promise<void> {
  try {
    await verifyFirebaseToken(req.headers.authorization);
  } catch {
    res.status(401).json({ error: 'Unauthenticated' });
...
export async function deletePaykuClient(req: Request, res: Response): Promise<void> {
  try {
    await verifyFirebaseToken(req.headers.authorization);
  } catch {
    res.status(401).json({ error: 'Unauthenticated' });
...
export async function listPaykuSubscriptionsV3(req: Request, res: Response): Promise<void> {
  try {
    await verifyFirebaseToken(req.headers.authorization);
  } catch {
    res.status(401).json({ error: 'Unauthenticated' });
...
export async function createPaykuSubscription(req: Request, res: Response): Promise<void> {
  try {
    await verifyFirebaseToken(req.headers.authorization);
  } catch {
    res.status(401).json({ error: 'Unauthenticated' });
...
export async function getPaykuSubscription(req: Request, res: Response): Promise<void> {
  try {
    await verifyFirebaseToken(req.headers.authorization);
  } catch {
    res.status(401).json({ error: 'Unauthenticated' });
...
export async function deletePaykuSubscription(req: Request, res: Response): Promise<void> {
  try {
    await verifyFirebaseToken(req.headers.authorization);
  } catch {
    res.status(401).json({ error: 'Unauthenticated' });
...
export async function affiliatePaykuCard(req: Request, res: Response): Promise<void> {
  try {
    await verifyFirebaseToken(req.headers.authorization);
  } catch {
    res.status(401).json({ error: 'Unauthenticated' });
...
export async function createPaykuTransactionForClient(req: Request, res: Response): Promise<void> {
  try {
    await verifyFirebaseToken(req.headers.authorization);
  } catch {
    res.status(401).json({ error: 'Unauthenticated' });
  ...
  try {
    ...
    const response = await paykuClient.post('/transaction', {
      ...
      urlnotify: 'https://revive-hogar.web.app/api/webhookPaymentCharge',
...
export async function syncHistoricPayments(req: Request, res: Response): Promise<void> {
  try {
    await verifyFirebaseToken(req.headers.authorization);
  } catch {
    res.status(401).json({ error: 'Unauthenticated' });
